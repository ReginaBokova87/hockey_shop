               ...
               <div id="catalog">
                  <div style="margin:40px; text-align:justify;">
                     ...
                     <p><b>1. Самовывоз в офисе интернет магазина*</b> <br>
                        ...
                        * Бесплатно, любой способ оплаты, возможна примерка и отказ
                     </p>
                     ...
                     <ul>
                        ...
                        <li>Возможен любой способ оплаты</li>
                     </ul>
                     </p>
                     ...
                     <ul>
                        ...
                        <li>Примерка не предусмотрена</li>
                     </ul>
                     </p>
                     ...
                     <ul>
                        ...
                        <li>Примерка до получения отсутствует</li>
                     </ul>
                     </p>
                     ...
                     <ul>
                        ...
                        <li>Примерка не предусмотрен</li>
                     </ul>
                     </p>
